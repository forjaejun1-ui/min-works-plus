const CACHE='min-works-plus-standalone-v84';
const ASSETS=['/min-works-plus/','/min-works/reader.css?v=design81','/min-works/plus-auth.css?v=design81','/min-works/plus-opening.js?v=design81','/min-works/plus-auth.js?v=design81','/min-works/reader.js?v=design84','/min-works/device-session.js?v=63','/min-works/plus-icon-design-192.png','/min-works/plus-icon-design-512.png'];
